...
const TvDetails = () => {
  ...
  return (
    <div
      ...
      className=" relative  h-screen pb-[5%] text-zinc-200 w-full px-[10%] overflow-y-auto"
    >
      ...
      <div className="w-full overflow-y-hidden h-[45vh] mt-4 pb-4">
        <h1 className="text-3xl font-bold">Seasons</h1>
       {info.detail.seasons.length>0? <HorizontalCards
      ...
      <hr  className="mt-4 " />
      <div className="w-full overflow-y-hidden h-[45vh] mt-4 p-4">
